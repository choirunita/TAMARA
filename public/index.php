...
switch ($page) {
    ...
    case 'scan':
        ...
        break;
    case 'upload_sto':
        require __DIR__.'/../app/views/sto/upload_sto.php';
        break;
    case 'sto_upload_process':
        require __DIR__.'/../app/controllers/StoUploadProcessController.php';
        break;
    case 'sto_pdf':
        require __DIR__ . '/../app/controllers/StoPdfListController.php';
        break;
    case 'sto_pdf_view':
        require __DIR__ . '/view_pdf.php';
        break;
